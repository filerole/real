(function ($) {
    ...
    $("#slider-range").slider({
        ...
        slide: function (event, ui) {
           $("#amount_one").val(ui.values[0] + " - " + " SAR" + ui.values[1] );
        }
    });
    $("#amount_one").val("SAR " + $("#slider-range").slider("values", 0) +
...
function setTheme(themeName) {
    localStorage.setItem('fela_rtl_theme', themeName);
    document.documentElement.className = themeName;
}

// function to toggle between light and dark theme
function toggleTheme() {
    if (localStorage.getItem('fela_rtl_theme') === 'theme-dark') {
